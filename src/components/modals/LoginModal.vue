<template>
  <div class="modal">
        ...
        <div class="Aut_div">
          <form @submit.prevent="userLogin" class="login_form">
            ...
            <div class="HelpLogin">
              ...
              ><span class="resset" @click="isShow = !isShow"
    ...
    <button class="join" @click="isShow = !isShow">LOGIN</button>
  </div>
</template>
...
.Aut_div {
  .input-box input:focus ~ span, input:valid ~ span {
